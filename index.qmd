...
pgm.add_text(label="Simplified Lind's Model (1747)", x=0, y=0.5, fontsize=8)
...
# Add a title to the DAG
pgm.add_text(label="Misguided Belief - Bacteria Theory (Late 19th Century)", x=-0.5, y=2.5, fontsize=10)
...
pgm.add_edge("acid", "bif")
pgm.add_edge("bif", "scurvy")
...
# Add a title to the DAG
pgm.add_text(label="Simplified Modern Understanding (1930s onwards)", x=-0.5, y=2.5, fontsize=10)

pgm.add_node("vitc", "Vitamin C", 0, 2, aspect = 3.4, scale = 1, plot_params={"facecolor": "lightblue", "edgecolor": "navy", "linewidth": 2, 'alpha': 0.6})
...
pgm.add_node("scurvy", "Scurvy", 3, 0, aspect = 3.4, scale = 1, plot_params={"facecolor": "thistle", "edgecolor": "purple", "linewidth": 2, 'alpha': 0.7})
