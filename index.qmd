...
pgm.add_plate([-1.5, -0.5, 5.8, 3])

# Add a title to the DAG
pgm.add_text(label="Misguided Belief - Bacteria Theory (Late 19th Century)", x=-1, y=2.6, fontsize=10)
...
pgm.add_plate([-1.5, -0.6, 5.8, 3])

# Add a title to the DAG
pgm.add_text(label="Simplified Modern Understanding (1930s onwards)", x=-0.9, y=2.5, fontsize=10)
