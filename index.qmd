...
# Add a title to the DAG
pgm.add_text(label="Misguided Belief - Bacteria Theory (Late 19th Century)", x=-0.65, y=2.5, fontsize=10)

pgm.add_node("acid", "Acid", 0, 2, aspect = 3.2, scale = 1, plot_params={"facecolor": "silver", "edgecolor": "black", "linewidth": 2, 'alpha': 0.4})
...
pgm.add_node("scurvy", "Scurvy", 3, 0, aspect = 3.2, scale = 1, plot_params={"facecolor": "thistle", "edgecolor": "purple", "linewidth": 2, 'alpha': 0.7})
...
# Add a title to the DAG
pgm.add_text(label="Simplified Modern Understanding (1930s onwards)", x=-0.3, y=2.5, fontsize=10)

pgm.add_node("vitc", "Vitamin C", 0.5, 2, aspect = 3.4, scale = 1, plot_params={"facecolor": "lightblue", "edgecolor": "navy", "linewidth": 2, 'alpha': 0.6})

pgm.add_node("colSyn", "Collagen Synthesis", 2, 1, aspect = 3.8, scale = 1, plot_params={"facecolor": "orange", "edgecolor": "brown", "linewidth": 2, 'alpha': 0.6})

pgm.add_node("scurvy", "Scurvy", 3.5, 0, aspect = 3.4, scale = 1, plot_params={"facecolor": "thistle", "edgecolor": "purple", "linewidth": 2, 'alpha': 0.7})
